...
export const metadata: Metadata = {
  ...
  verification: {
    google: "etyJOrx_ZDh107lMdDlDI-LrmZREck9z-F5e9YXGFng",
  },
  icons: {
    icon: "/logo.png",
  },
          ...
          <div className="container" style={{ 
            ...
            <Link href="/" style={{ 
              ...
              <div style={{
                ...
                <Image src="/logo.png" alt="Logo PP Anwarul Hidayah" width={38} height={38} priority />
              </div>
              <div style={{ textAlign: 'left', lineHeight: 1.1 }}>
                <h3 style={{ margin: 0, fontSize: '1.15rem', color: 'var(--primary-dark)', letterSpacing: '-0.01em', fontWeight: 800 }}>
                  ANWARUL <span style={{ color: 'var(--secondary)' }}>HIDAYAH</span>
                </h3>
                <p className="hide-on-mobile" style={{ margin: '2px 0 0 0', fontSize: '0.65rem', color: 'var(--text-muted)', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase' }}>
                  Kalisalak - Tegal
                </p>
              </div>
            </Link>
            ...
            <nav className="hide-on-mobile" style={{ 
              ...
              <Link href="/#biaya" className="nav-link">Biaya</Link>
            </nav>

            {/* CTA Section */}
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
              <Link href="/pendaftaran" className="btn btn-primary" style={{ 
                padding: '0.6rem 1.5rem', 
                fontSize: '0.9rem',
                borderRadius: '0.75rem',
                boxShadow: '0 10px 20px -10px rgba(37, 99, 235, 0.5)'
              }}>
                Daftar <span className="hide-on-mobile">Sekarang</span>
              </Link>
            </div>
          </div>
        </header>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '4rem', marginBottom: '3rem', justifyContent: 'space-between' }}>
              ...
              <div style={{ flex: '1 1 350px' }}>
                ...
                <div style={{ display: 'flex', gap: '1rem' }}>
                  ...
                  {/* TikTok */}
                  <a href="https://www.tiktok.com/@pondokanwarulhida" target="_blank" rel="noopener noreferrer" style={{ width: '40px', height: '40px', borderRadius: '50%', background: '#1e293b', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', transition: 'all 0.3s' }}>
                    <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24"><path d="M12.525.02c1.31-.036 2.612.01 3.91-.043 0 1.226.012 2.452-.004 3.678.707.016 1.415.064 2.113.156.633.085 1.258.239 1.85.482.01 1.203.007 2.406.006 3.61-.53-.116-1.065-.213-1.61-.275-.762-.09-1.526-.08-2.286.03V14a4.545 4.545 0 0 1-5.7 4.356A4.545 4.545 0 1 1 14.85 14h1.44a6 6 0 1 0-7.74 5.76c.01 0 .014 0 .014.02V4.48c1.82.093 3.497 1.1 4.55 2.62 0-2.32-.009-4.64-.01-6.96-.15-.044-.3-.08-.45-.12z" /></svg>
                  </a>
                  {/* WhatsApp Channel */}
